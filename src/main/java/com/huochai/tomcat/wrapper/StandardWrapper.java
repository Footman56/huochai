package com.huochai.tomcat.wrapper;
...
public class StandardWrapper extends ContainerBase implements Wrapper {
    ...
    private com.huochai.tomcat.servlet.ServletConfig servletConfig;
        ...
        if (servletClass != null && !servletClass.isEmpty()) {
            try {
                ...
                if (servlet instanceof com.huochai.tomcat.servlet.Servlet) {
                    ((com.huochai.tomcat.servlet.Servlet) servlet).init(servletConfig);
                }
            } catch (Exception e) {
     ...
     */
    public com.huochai.tomcat.servlet.ServletConfig getServletConfig() {
        return servletConfig;
    }
    ...
    protected void stopInternal() throws LifecycleException {
        // 销毁Servlet
        if (servlet != null && servlet instanceof com.huochai.tomcat.servlet.Servlet) {
            try {
                ((com.huochai.tomcat.servlet.Servlet) servlet).destroy();
            } catch (Exception e) {
     ...
     * 标准Wrapper配置
     */
    private static class StandardWrapperConfig implements com.huochai.tomcat.servlet.ServletConfig {
        ...
        @Override
        public com.huochai.tomcat.servlet.ServletContext getServletContext() {
            if (wrapper.getParent() instanceof Context) {
                return (com.huochai.tomcat.servlet.ServletContext) wrapper.getParent();
            }
            return null;
        }
