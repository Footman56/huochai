...
import com.huochai.huochai.tomcat.servlet.ServletRequest;
import com.huochai.huochai.tomcat.servlet.ServletResponse;
...
public class StandardFilterChain implements FilterChain {
    ...
    public void doFilter(ServletRequest request, ServletResponse response) {
        if (position < filters.size()) {
            ...
            try {
                ((com.huochai.huochai.tomcat.servlet.Servlet) servlet).service(request, response);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
