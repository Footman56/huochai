...
public class StandardWrapperValve extends StandardValve {
    ...
    private final com.huochai.huochai.tomcat.core.Wrapper wrapper;

    public StandardWrapperValve(com.huochai.huochai.tomcat.core.Wrapper wrapper) {
    ...
    protected void invokeInternal(Request request, Response response) throws Exception {
        ...
        if (servlet instanceof com.huochai.huochai.tomcat.servlet.Servlet) {
            com.huochai.huochai.tomcat.servlet.Servlet s = (com.huochai.huochai.tomcat.servlet.Servlet) servlet;

            System.out.println("[Debug] Calling servlet: " + s.getClass().getName());

            // 创建HTTP请求/响应适配器
            s.service(
                new com.huochai.huochai.tomcat.servlet.http.HttpServletRequestAdapter(request),
                new com.huochai.huochai.tomcat.servlet.http.HttpServletResponseAdapter(response)
            );
