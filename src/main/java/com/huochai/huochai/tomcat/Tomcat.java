package com.huochai.huochai.tomcat;

import com.huochai.huochai.tomcat.config.ServerConfig;
import com.huochai.huochai.tomcat.connector.Connector;
import com.huochai.huochai.tomcat.context.StandardContext;
import com.huochai.huochai.tomcat.core.Engine;
import com.huochai.huochai.tomcat.core.Host;
import com.huochai.huochai.tomcat.engine.StandardEngine;
import com.huochai.huochai.tomcat.host.StandardHost;
import com.huochai.huochai.tomcat.pipeline.StandardPipeline;
import com.huochai.huochai.tomcat.pipeline.StandardEngineValve;
import com.huochai.huochai.tomcat.pipeline.StandardHostValve;
import com.huochai.huochai.tomcat.wrapper.StandardWrapper;
...
public class Tomcat {
    ...
    public StandardContext addWebapp(String contextPath, String docBase) {
        ...
        // 设置Context的管道基础阀门
        com.huochai.huochai.tomcat.pipeline.StandardPipeline contextPipeline =
            (com.huochai.huochai.tomcat.pipeline.StandardPipeline) context.getPipeline();
        contextPipeline.setBasic(new com.huochai.huochai.tomcat.pipeline.StandardContextValve(context));
    ...
    public Tomcat addServlet(String contextPath, String urlPattern,
                             Class<? extends com.huochai.huochai.tomcat.servlet.Servlet> servletClass) {
        if (engine == null) {
            initEngine();
        }
        ...
        // 设置Wrapper的管道基础阀门
        com.huochai.huochai.tomcat.pipeline.StandardPipeline wrapperPipeline =
            (com.huochai.huochai.tomcat.pipeline.StandardPipeline) wrapper.getPipeline();
        wrapperPipeline.setBasic(new com.huochai.huochai.tomcat.pipeline.StandardWrapperValve(wrapper));
    ...
    public static void main(String[] args) throws Exception {
        ...
        tomcat.setPort(8421);
        tomcat.start();
        tomcat.addServlet("/", "/hello", com.huochai.huochai.tomcat.demo.HelloServlet.class);
