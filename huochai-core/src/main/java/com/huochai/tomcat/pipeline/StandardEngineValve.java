...
public class StandardEngineValve extends StandardValve {
    ...
    private final com.huochai.tomcat.core.Engine engine;

    public StandardEngineValve(com.huochai.tomcat.core.Engine engine) {
        this.engine = engine;
    ...
    protected void invokeInternal(Request request, Response response) throws Exception {
        ...
        com.huochai.tomcat.core.Host host = engine.findHost(hostName);
