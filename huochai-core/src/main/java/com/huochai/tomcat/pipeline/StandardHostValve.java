...
public class StandardHostValve extends StandardValve {
    ...
    private final com.huochai.tomcat.core.Host host;

    public StandardHostValve(com.huochai.tomcat.core.Host host) {
        this.host = host;
        setName("host-valve");
    }
    ...
    protected void invokeInternal(Request request, Response response) throws Exception {
        ...
        com.huochai.tomcat.core.Context context = null;

        if (host instanceof com.huochai.tomcat.host.StandardHost) {
            com.huochai.tomcat.host.StandardHost h =
                (com.huochai.tomcat.host.StandardHost) host;
