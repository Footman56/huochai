...
public class StandardContextValve extends StandardValve {
    ...
    private final com.huochai.tomcat.core.Context context;

    public StandardContextValve(com.huochai.tomcat.core.Context context) {
    ...
    protected void invokeInternal(Request request, Response response) throws Exception {
        // 映射到Wrapper
        com.huochai.tomcat.core.Wrapper wrapper = null;
        ...
        if (context instanceof com.huochai.tomcat.context.StandardContext) {
            com.huochai.tomcat.context.StandardContext ctx =
                (com.huochai.tomcat.context.StandardContext) context;
