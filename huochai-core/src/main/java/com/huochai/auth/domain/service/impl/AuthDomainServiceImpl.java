...
import com.huochai.auth.domain.event.DomainEventPublisher;
...
import com.huochai.auth.domain.service.AuthDomainService;
...
public class AuthDomainServiceImpl implements AuthDomainService {
    ...
    public AuthUser authenticate(String username, String password) {
        ...
        log.debug("[认证服务] 用户查询成功: userId={}, username={}", user.getId(), user.getUsername());

        // ========== 验证密码 ==========
        log.debug("[认证服务] 验证密码: userId={}", user.getId());
        ...
        // ========== 验证账号状态 ==========
        log.debug("[认证服务] 验证账号状态: userId={}", user.getId());
