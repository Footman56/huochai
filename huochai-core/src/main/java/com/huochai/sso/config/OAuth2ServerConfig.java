package com.huochai.sso.config;
...
public class OAuth2ServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient webClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("https://localhost:8443/login/oauth2/code/web-app")
        ...
        RegisteredClient appClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("mobile-app")
                .clientSecret("{bcrypt}$2a$10$GRLdNijSQMUvl/au9ofL.eDwmoohzzS7.rmNSJZ.0FxO/BTk76klX")
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
        ...
        return new InMemoryRegisteredClientRepository(webClient, appClient);
    }
